...
const footerLinks = {
  services: [
    ...
    { label: 'End of Lease', href: '/services' },
  ...
  regions: [
    { label: 'New South Wales', href: '/regions' },
    { label: 'Victoria', href: '/regions' },
    { label: 'Queensland', href: '/regions' },
    { label: 'Western Australia', href: '/regions' },
    { label: 'South Australia', href: '/regions' },
    { label: 'Tasmania', href: '/regions' },
    { label: 'ACT', href: '/regions' },
    { label: 'Northern Territory', href: '/regions' },
  ],
  company: [
  ...
  legal: [
    ...
    { label: 'GST Information', href: '/about' },
  ],
  support: [
    { label: 'FAQ', href: '/contact' },
    { label: 'Service Areas', href: '/regions' },
